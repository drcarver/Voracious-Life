...
internal class OpfWriter
{
    public static string Format(OpfDocument opf)
    {
        ...
        {
            case Enum.EpubVersionEnum.Epub2:
                versionString = "2.0";
                break;
            case Enum.EpubVersionEnum.Epub3:
                versionString = "3.0";
                break;
            default:
    ...
    private static XElement WriteMetadata(OpfMetadata metadata, EpubVersionEnum version)
    {
