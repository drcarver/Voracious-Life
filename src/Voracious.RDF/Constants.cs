...
public class Constants
{
    ...
    public static readonly string XmlDeclarationSufi = "?>";
    ...
    public static readonly string IANAApplication = "https://www.iana.org/assignments/media-types/application.csv";
    public static readonly string IANAAudio = "https://www.iana.org/assignments/media-types/audio.csv";
    public static readonly string IANAImage = "https://www.iana.org/assignments/media-types/image.csv";
    public static readonly string IANAText = "https://www.iana.org/assignments/media-types/text.csv";
    public static readonly string IANAVideo = "https://www.iana.org/assignments/media-types/video.csv";
}
