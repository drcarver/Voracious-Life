...
class BookmarkFileDirectory
{
    ...
    public static async Task<string> GetBookmarkFolderPathAsync()
    {
        ...
        try
        {
            if (StorageApplicationPermissions.FutureAccessList.ContainsItem(BOOKMARKFILETOKEN))
            {
                folder = await StorageApplicationPermissions.FutureAccessList.GetFolderAsync(BOOKMARKFILETOKEN);
            }
            else
            {
    ...
    public static async Task<StorageFolder> PickBookmarkFolderAsync()
    {
        ...
        var picker = new FolderPicker()
        {
            ...
            SettingsIdentifier = BOOKMARKFILETOKEN,
        };
    ...
    public static void UpdateOrReplaceFutureAccessList(StorageFolder folder)
    {
        ...
        StorageApplicationPermissions.FutureAccessList.AddOrReplace(BOOKMARKFILETOKEN, folder);
    }
