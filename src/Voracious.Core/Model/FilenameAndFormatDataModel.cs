...
public class FilenameAndFormatDataModel : IFilenameAndFormatData
{
    /// <summary>
    ...
    /// <returns></returns>
    public List<FilenameAndFormatDataModel> GetProcessedFileList(List<FilenameAndFormatDataModel> start)
    {
        ...
        var sortedlist = new List<FilenameAndFormatDataModel>();
        var retval = new List<FilenameAndFormatDataModel>();
